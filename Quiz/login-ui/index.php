...
<body >
	...
	<div class="limiter" >
		<div class="container-login100" style="background-color: #9b9b9b;">
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form" style="background-color: #454545;">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100" style="color: #f1f4f6;"><b>Email</b></span>
						<input class="input100" type="text" name="username" placeholder="Enter email" style="color: #f1f4f6;">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100" style="color: #f1f4f6;"><b>Password</b></span>
						<input class="input100" type="password" name="pass" placeholder="Enter password" style="color: #f1f4f6;">
						<span class="focus-input100"></span>
					</div>
					...
					<!-- <div align="right">
						<button href="./quiz/admin/index.php" style = "margin-top: 20px; margin-left: 50px;">
							Login as Tutor
						</button>
					</div> -->
