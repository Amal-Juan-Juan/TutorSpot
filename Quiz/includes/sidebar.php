    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading" style="color: #4FFFCA;">AVAILABLE QUIZZES</li>
                <li>
                <a href="#">
                ...
                <ul style="color: #f1f4f6;">
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>No Quizzes @ the moment
                            </a>
                        <?php }
                     ?>
                 ...
                 <li class="app-sidebar__heading" style="color: #4FFFCA;">TAKEN Quizzes</li>
                <li style="color: #f1f4f6;">
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">You are not taking quiz yet</a>
                    <?php }
