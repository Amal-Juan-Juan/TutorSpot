...
<div class="app-main__inner">
    <div class="col-md-12">
         <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading" style="color: #f1f4f6;">
                        <div>
                            <b><?php echo $selExam['ex_title']; ?></b>
                    ...
                    <div class="page-title-actions mr-5" style="font-size: 20px;">
                        <form name="cd">
                          ...
                          <label style="color: #f1f4f6;">Remaining Time : </label>
    ...
    <div class="col-md-12 p-0 mb-4" style="background-color: #f1f4f6;">
