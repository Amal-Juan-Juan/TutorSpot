...
<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card" style="background-color: #454545; color: #f1f4f6;">
                                              ...
                                              <?php 
                                                ...
                                                <span>
                                                    <?php 
                                                        ...
                                                        // $score = $conn->query("INSERT INTO course_tbl(cou_name) VALUES('$course_name') ");
                                                        $ans = $score / $over * 100;
                                                        echo number_format($ans,2);
                                                        // echo "$ans";
                                                        echo "%";
                                                        $quer = $conn->query("INSERT INTO scores(score) VALUES('$ans')");
