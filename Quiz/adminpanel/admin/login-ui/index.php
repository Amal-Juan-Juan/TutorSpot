	...
	<div class="limiter">
		<div class="container-login100" style="background-color: #9b9b9b;">
			<div class="wrap-login100">
				...
				<form method="post" id="adminLoginFrm" class="login100-form validate-form" style="background-color: #454545;">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required" >
						<span class="label-input100" style="color: #f1f4f6;"><b>Username</b></span>
						<input class="input100" type="text" name="username" placeholder="Enter username" style="color: #f1f4f6;">
