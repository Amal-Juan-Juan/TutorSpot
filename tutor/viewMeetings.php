...
<body>
    ...
    <?php
        ...
        <div class="row justify-content-center">
            ...
            $sql="select * from meetings where temail='$email' and (sstart>'$currDate' or (sstart='$currDate' and  stime > '$currTime'))";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td><a href='https://tarpvideocall.netlify.app' target='_blank'>Open Link</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
