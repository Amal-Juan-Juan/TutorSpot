...
$year=$_POST['year'];
$uni=$_POST['uni'];
$sql=mysqli_query($con,"insert into tutordetails values('$email','$name','$age','$gender','$phone','$year','$city','$uni','na')");
if($sql)
{
    //if successfull entry in database
    $sql1="update logint set completed='completed' where email='$email'";
